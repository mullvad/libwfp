...
class ConditionRemotePortRange : public IFilterCondition
{
public:

	ConditionRemotePortRange(uint16_t firstPort, uint16_t lastPort, const IStrictComparison &comparison = CompareEq());
